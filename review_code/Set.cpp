...
////	pair<string, string> kv1("first", "diyige");
////	dict.insert(kv1);
////	dict.insert(pair<string, string>("second", "diergr"));
////	dict.insert(make_pair("sort", "zhonglei"));
////	//c++11
////	dict.insert( {"auto","zidong"} );
////	//插入时只看key,value不相等不会更新
////	dict.insert({ "auto","zidongxxxx" });
////	//遍历map
////	//c++不支持返回多个值，就用pair封装
...
int main()
{
	...
	dict["insert"];
	dict["left"] = "zuobian";
	dict["left"] = "zuobian,shengxu";
	cout << dict["left"] << endl;
	cout << dict["roght"] << endl;
	return 0;
}
